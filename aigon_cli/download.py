...
def register_download_commands(subparsers) -> None:
    ...
    download_parser = subparsers.add_parser(
        'download',
        help='Download note, attachment, or file by unique_id'
    )
    ...
    download_parser.add_argument(
        ...
        default=None,
        metavar='DIRECTORY',
        help='Download to directory (default: current directory). '
             'Without this flag, output to stdout (text only).'
    )
    ...
    download_parser.add_argument(
        ...
        default=None,
        metavar='FILENAME',
        help='Custom filename to save as (overrides --uniquefn). '
             'Example: --filename my_file.jpg'
    )
